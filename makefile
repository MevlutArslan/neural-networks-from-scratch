...
SRC_FILES = $(wildcard $(SRC_DIR)/*.c) $(wildcard $(SRC_DIR)/helper/*.c) $(wildcard $(SRC_DIR)/nmath/*.c) $(wildcard $(SRC_DIR)/neural_network/*.c) $(wildcard $(SRC_DIR)/neural_network/activation_functions/*.c)
