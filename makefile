...
SRC_FILES = $(wildcard $(SRC_DIR)/*.c) $(wildcard $(SRC_DIR)/helper/*.c) $(wildcard $(SRC_DIR)/helper/data_processing/*.c) $(wildcard $(SRC_DIR)/nmath/*.c) $(wildcard $(SRC_DIR)/neural_network/*.c) $(wildcard $(SRC_DIR)/neural_network/activation_functions/*.c)
TEST_FILES = $(wildcard $(TEST_DIR)/*.c) $(wildcard $(TEST_DIR)/helper_tests/*.c) $(wildcard $(TEST_DIR)/math_tests/*.c) $(wildcard $(TEST_DIR)/matrix_tests/*.c) $(wildcard $(TEST_DIR)/neural_network_tests/*.c)
